                ...
                <ul className='lg:flex justify-center items-center gap-10 hidden'>
                    {publicRoutes.map((item, index) => (
                        <li key={index} onClick={() => setActiveLink(index)}
                            className={`relative pb-1 after:rounded-full after:conten-[''] after:absolute after:left-0 after:bottom-0 after:h-[4px] after:bg-[#841414] after:transition-all after:duration-300 ${activeLink === index ? "after:w-full text-[#841414]" : "after:w-0 text-black"} hover:after:w-full hover:text-[#841414]`}>
